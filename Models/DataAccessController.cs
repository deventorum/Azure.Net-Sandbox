...
namespace CoursesWebApp.Models
{
    ...
    {
        private string connectionString = "Server=tcp:courseserver546.database.windows.net,1433;Initial Catalog=coursedatabase546;Persist Security Info=False;User ID=azuresql;Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
